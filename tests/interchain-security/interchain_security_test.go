...
import (
	...
	appConsumer "github.com/bitvalidatorlove-ventures/bitvalidator/app"
...
// NewCoordinator initializes Coordinator with interchain security dummy provider and bitvalidator consumer chain
